...
def home(request):
    ...
    latest_documents = all_documents[:3]
    latest_passport_docs = passport_docs[:3]
    latest_invoice_docs = invoice_docs[:3]
    latest_check_docs = check_docs[:3]
    latest_resume_docs = resume_docs[:3]
    latest_license_docs = license_docs[:3]
    ...
    latest_shared_docs = shared_docs[:1]
